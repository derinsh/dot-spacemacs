...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(flycheck-posframe all-the-icons rustic yuck-mode use-package ligature good-scroll)
...
(add-hook 'prog-mode-hook 'undo-tree-mode)
  ...
  (defun customkeys ()
    ...
    (evil-define-key '(normal insert visual motion emacs) 'global (kbd "<C-\\>") #'comment-region)
    (evil-define-key '(normal insert visual motion emacs) 'global (kbd "<C-|>") #'uncomment-region))
...
(custom-set-variables
 ...
 '(all-the-icons-alltheicon-scale-factor 1.1)
 ...
 '(haskell-process-path-cabal "/home/psi/.ghc/bin/cabal")
 '(haskell-process-path-ghci "/home/psi/.ghc/bin/ghci")
 ...
 '(package-selected-packages
   '(good-scroll ligature which-key hybrid-mode holy-mode font-lock+ evil-evilified-state dotenv-mode diminish ws-butler writeroom-mode winum volatile-highlights vim-powerline vi-tilde-fringe uuidgen undo-tree treemacs-projectile treemacs-persp treemacs-icons-dired treemacs-evil toc-org term-cursor symon symbol-overlay string-edit-at-point spacemacs-whitespace-cleanup spacemacs-purpose-popwin spaceline-all-the-icons space-doc restart-emacs rainbow-delimiters quickrun popwin password-generator paradox overseer org-superstar open-junk-file nameless multi-line lorem-ipsum link-hint inspector info+ indent-guide hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation hide-comnt help-fns+ helm-xref helm-themes helm-swoop helm-purpose helm-projectile helm-org helm-mode-manager helm-make helm-descbinds helm-ag google-translate golden-ratio flycheck-package flycheck-elsa flx-ido fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-surround evil-numbers evil-nerd-commenter evil-matchit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-easymotion evil-collection evil-cleverparens evil-args evil-anzu emr elisp-slime-nav elisp-def editorconfig dumb-jump drag-stuff dired-quick-sort devdocs define-word column-enforce-mode clean-aindent-mode centered-cursor-mode auto-highlight-symbol auto-compile aggressive-indent ace-link ace-jump-helm-line zeal-at-point yuck-mode yasnippet-snippets yapfify web-mode web-beautify typo typescript-mode treemacs-magit treemacs-all-the-icons tree-sitter-langs toml-mode tide terminal-here tagedit systemd sql-indent sphinx-doc smeargle slime-company slim-mode shfmt shell-pop seeing-is-believing scss-mode sass-mode rvm rustic ruby-tools ruby-test-mode ruby-refactor ruby-hash-syntax rubocopfmt rubocop rspec-mode ron-mode robe rjsx-mode rbenv ranger rake rainbow-mode rainbow-identifiers racket-mode pytest pylookup pyenv-mode pydoc py-isort pug-mode prettier-js poetry pippel pipenv pip-requirements pdf-view-restore orgit-forge org-rich-yank org-ref org-projectile org-present org-pomodoro org-mime org-download org-contrib org-cliplink ob-elixir npm-mode nose nodejs-repl multi-vterm multi-term mmm-mode minitest markdown-toc lsp-ui lsp-python-ms lsp-pyright lsp-origami lsp-latex lsp-haskell livid-mode live-py-mode json-reformat json-navigator json-mode js2-refactor js-doc journalctl-mode insert-shebang importmagic impatient-mode ibuffer-projectile hlint-refactor hindent helpful helm-rtags helm-pydoc helm-org-rifle helm-lsp helm-ls-git helm-hoogle helm-git-grep helm-dash helm-css-scss helm-company helm-cider helm-c-yasnippet helm-bibtex haskell-snippets google-c-style godoctor go-tag go-rename go-impl go-guru go-gen-test go-fill-struct go-eldoc gnuplot gitignore-templates git-timemachine git-modes git-messenger git-link git-gutter-fringe gh-md gendoxy geiser-racket fuzzy flycheck-ycmd flycheck-rust flycheck-rtags flycheck-posframe flycheck-pos-tip flycheck-joker flycheck-haskell flycheck-credo flycheck-clj-kondo flycheck-bashate fish-mode extempore-mode evil-tex evil-org eshell-z eshell-prompt-extras esh-help erlang emmet-mode disaster dap-mode dante cython-mode csv-mode cpp-auto-include copy-as-format company-ycmd company-web company-statistics company-shell company-rtags company-reftex company-quickhelp company-math company-go company-cabal company-c-headers company-box company-auctex company-anaconda common-lisp-snippets color-identifiers-mode code-cells cmm-mode clojure-snippets cider-eval-sexp-fu chruby ccls cargo bundler browse-at-remote blacken auto-yasnippet auctex-latexmk attrap alchemist ac-ispell centaur-tabs))
...
(custom-set-faces
 ...
 '(mode-line ((t (:height 1.05 :box (:line-width (1 . 1) :color "#5d4d7a") :foreground "light slate gray" :background "#222226"))))
